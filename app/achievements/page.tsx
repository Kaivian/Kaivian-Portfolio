...
const mockCertificates = Array.from({ length: 10 }, (_, i) => ({
...
export default function AchievementsPage() {
  return (
    <main className="min-h-screen px-[18px] pt-20 md:pt-[18px] md:ml-[calc(min(100vw*0.25,450px)+18px)] flex flex-col gap-[18px]">
      <section className="rounded-xl bg-surface-light dark:bg-surface-dark p-[25px] text-gray-900 dark:text-white border border-zinc-300 dark:border-surface-dark shadow-lg">
        <h2 className="text-2xl font-semibold mb-4 flex items-center gap-2">
          <LiaCertificateSolid className="text-gray-900 dark:text-white" />
